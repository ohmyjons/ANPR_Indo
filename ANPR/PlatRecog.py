...
# img = cv.imread(r"test images\2.jpg") # salah segmentasi platnomer
# img = cv.imread(r"test images\09.jpg") #salah segmentasi karakter
# img = cv.imread(r"test images\9.jpg") 
# img = cv.imread(r"test images\10.jpg") #salah segmentasi karakter
# img = cv.imread(r"test images\123.jpg")  #salah segmentasi platnomer
# img = cv.imread(r"test images\124.jpg") #segmentasi plat salah
# img = cv.imread(r"test images\AA5627JT.jpg")
# img = cv.imread(r"test images\AB2638XU.jpg")
# img = cv.imread(r"test images\AB5592EG.jpg")
...
# pencahayaan plat buruk
def lowlight(img_gray):
    # tophat
...
if index_chars_candidate == []:
    ...
    model = keras.models.load_model('ALPR-IndonesiaPlateNumber-main\my_model')
